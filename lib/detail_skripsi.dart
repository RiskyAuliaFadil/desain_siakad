...
class DetailSkripsi extends StatefulWidget {
  const DetailSkripsi({super.key});

  @override
  State<DetailSkripsi> createState() => _DetailSkripsiState();
}

class _DetailSkripsiState extends State<DetailSkripsi> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: Card(
                    color: const Color.fromARGB(
                        255, 250, 204, 0), // Warna latar belakang Card
                    ...
                    child: const Padding(
                      padding:
                          EdgeInsets.all(20), // Padding di dalam Card
                      child: Column(
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'JUDUL SKRIPSI', // Teks di bawah Card
                        style: TextStyle(
